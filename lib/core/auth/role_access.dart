...
class RoleAccess {
  ...
  static const Map<String, Set<UserRole>> routeRoles = {
    ...
    '/checkins': {UserRole.personnel},
    '/tara': {UserRole.personnel},
    '/mindfulness': {UserRole.personnel},
    '/mindfulness/breathing': {UserRole.personnel},
    '/mindfulness/meditation': {UserRole.personnel},
    '/mindfulness/history': {UserRole.personnel},
    '/mindfulness/mood': {UserRole.personnel},
    '/mindfulness/doodle': {UserRole.personnel},
    ...
    '/active-alerts': {UserRole.hrAdmin, UserRole.welfareOfficer},
