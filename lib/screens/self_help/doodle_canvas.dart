...
class DoodleCanvas extends StatefulWidget {
  const DoodleCanvas({super.key, this.initialDoodleId, this.onSaved});
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Icon(Icons.brush_outlined,
                                        color: onCanvas, size: 26),
                                    const SizedBox(height: 8),
                                    Text(
                                      'Look at the reference below and draw "${_doodle.title}"…',
                        ...
                        child: GestureDetector(
                          ...
                          onPanEnd: (_) => setState(() {
                            if (_current.isNotEmpty) {
                              _history.add(_Stroke(
                                  _current, _color, _brushSize, _brush));
                            }
                            _current = [];
                          }),
                        ),
